...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LogEntry.created_at'
        db.add_column('main_logentry', 'created_at', self.gf('django.db.models.fields.TimeField')(default=datetime.time(12, 18, 31, 163268)), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'LogEntry.created_at'
        db.delete_column('main_logentry', 'created_at')
    ...
    models = {
        ...
        'main.logentry': {
            ...
            'created_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(12, 18, 31, 201642)'}),
