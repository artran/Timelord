...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogEntry.logged_on'
        db.add_column('main_logentry', 'logged_on', self.gf('django.db.models.fields.DateField')(default=datetime.date.today), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LogEntry.logged_on'
        db.delete_column('main_logentry', 'logged_on')
