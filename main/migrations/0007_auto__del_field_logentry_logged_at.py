...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogEntry.logged_at'
        db.delete_column('main_logentry', 'logged_at')

    def backwards(self, orm):
        # Adding field 'LogEntry.logged_at'
        db.add_column('main_logentry', 'logged_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
    ...
    models = {
        ...
        'main.logentry': {
            ...
            'created_at': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(12, 22, 46, 910575)'}),
