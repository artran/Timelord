...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogEntry.invoiced'
        db.add_column('main_logentry', 'invoiced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'LogEntry.invoiced'
        db.delete_column('main_logentry', 'invoiced')
